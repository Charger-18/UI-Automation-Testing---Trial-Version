...
def Enter_health_record():
    safe_touch(Template(r"tpl1761641977886.png", record_pos=(0.374, 0.876), resolution=(1176, 2480)))
...
#     swipe(Template(r"tpl1761879916842.png", record_pos=(-0.302, 0.556), resolution=(1176, 2480)), vector=[0.0062, -0.3524])
    ...
    assert_exists(Template(r"tpl1761812740910.png", record_pos=(-0.003, -0.897), resolution=(1176, 2480)), "请填写测试点")
    assert_exists(Template(r"tpl1761812749495.png", record_pos=(-0.004, -0.457), resolution=(1176, 2480)), "请填写测试点")
...
#     assert_not_exists(Template(r"tpl1761812860352.png", threshold=0.8500000000000001, record_pos=(-0.007, 0.505), resolution=(1176, 2480)), "请填写测试点")
    ...
    assert_exists(Template(r"tpl1761813369487.png", threshold=0.75, rgb=True, record_pos=(0.156, -0.315), resolution=(1176, 2480)), "体重数据表")
    touch(Template(r"tpl1761813401060.png", record_pos=(0.004, -0.766), resolution=(1176, 2480)))
    assert_exists(Template(r"tpl1761813369487.png", threshold=0.6999999999999998, rgb=True, record_pos=(0.156, -0.315), resolution=(1176, 2480)), "体重数据表")
    ...
    assert_not_exists(Template(r"tpl1761813903130.png", threshold=0.9500000000000002, record_pos=(0.235, 0.565), resolution=(1176, 2480)), "删除卡片")
    ...
    assert_exists(Template(r"tpl1761813965737.png", threshold=0.9000000000000001, record_pos=(0.24, 0.573), resolution=(1176, 2480)), "请填写测试点")
...
test_Health_Data_info()

# ===========================体检报告=======================
def test_Medical_Examination_Report_info():
...
test_Medical_Examination_Report_info()

# ===========================健康报告=======================
def test_Health_Report_info():
    ...
    safe_assert_exists(Template(r"tpl1761012759077.png", record_pos=(-0.006, 0.233), resolution=(1440, 3200)), "睡眠报告无数据")
    safe_assert_exists(Template(r"tpl1761012881972.png", record_pos=(0.403, -0.851), resolution=(1440, 3200)), "请填写测试点")
    safe_touch(Template(r"tpl1761012894493.png", record_pos=(-0.407, -0.85), resolution=(1440, 3200)))
    safe_touch(Template(r"tpl1761012913023.png", record_pos=(0.399, -0.85), resolution=(1440, 3200)))
    ...
    touch(Template(r"tpl1761012823960.png", record_pos=(-0.423, -0.975), resolution=(1440, 3200)))

    touch(Template(r"tpl1761012795776.png", record_pos=(-0.303, -0.618), resolution=(1440, 3200)))
    safe_assert_exists(Template(r"tpl1761012805606.png", record_pos=(-0.007, 0.226), resolution=(1440, 3200)), "睡眠报告无数据")
    ...
    touch(Template(r"tpl1761012823960.png", record_pos=(-0.423, -0.975), resolution=(1440, 3200)))
    touch(Template(r"tpl1761012823960.png", record_pos=(-0.423, -0.975), resolution=(1440, 3200)))
test_Health_Report_info()

# ===========================医护建议=======================
def test_Medical_advice_info():
