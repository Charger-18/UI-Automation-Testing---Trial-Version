...
def Add_friends():
    ...
    if not safe_touch(Template(r"tpl1761639040673.png", record_pos=(-0.26, 0.166), resolution=(1176, 2480))):
        safe_touch(Template(r"tpl1754459781833.png", target_pos=8, record_pos=(-0.287, -0.023), resolution=(1440, 3200)))
    ...
    touch(Template(r"tpl1754459961552.png", record_pos=(-0.004, 0.808), resolution=(1440, 3200)))
