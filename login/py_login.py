...
# ----------- 快捷登录-------------
def Quick_login():
    safe_touch(Template(r"tpl1754463699535.png", record_pos=(0.028, -0.973), resolution=(1440, 3200)))
    ...
    safe_touch(Template(r"tpl1761637161166.png", record_pos=(-0.014, 0.179), resolution=(1176, 2480)))
    sleep(2.0)
